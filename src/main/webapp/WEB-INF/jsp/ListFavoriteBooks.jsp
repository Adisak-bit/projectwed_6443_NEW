...
<body>
                    ...
                    <c:when test="${not empty sessionScope.member}">
                        <div class="user-menu" id="user-menu">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="<c:url value='/favoriteBooks'/>" class="active">หนังสือที่ชื่นชอบ</a>
    ...
    <div class="container">
        <main class="favorite-books-container">
            <h2>หนังสือเล่มโปรด</h2>

            <div class="book-cards">
                <c:choose>
                    <c:when test="${not empty favoriteBookList}">
                    ...
                    <c:otherwise>
                        <p style="text-align: center; width: 100%; color: #666;">คุณยังไม่มีหนังสือเล่มโปรด</p>
                    </c:otherwise>
                </c:choose>
            </div>
        </main>
            ...
            readButtons.forEach(button => {
                 button.addEventListener('click', function() {
                     ...
                     if (accessLevel === 'public' || (accessLevel === 'member' && isLoggedIn)) {
                          ...
                          console.warn("Unknown access level for favorite:", accessLevel, "for book ID:", bookId);
                          window.location.href = viewBookUrl;
                     }
                 });
            });
